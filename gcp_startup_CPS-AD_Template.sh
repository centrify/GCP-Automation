...
ENROLLMENT_CODE=AXXXXXXX-4XXX-4XXX-4XXX-CXXXXXXXXXXX
...
CONNECTOR_URL="https://connector.yourcompany.com:8080"
CONNECTOR="connector_friendly_name"

#
# Parameters for AD Join
AD_CONTAINER="ou=GCP,dc=yourcompany,dc=com"
ZONE="Centrify_Zone_Name"
JOIN_USER="computerjoin@yourcompany.com"
# be sure to restrict rights of this account to only enable join to a specific OU
JOIN_PASSWORD="password_goes_here"
# Be sure to protect this file
# you can optionally change this to leverage a Kerberos Ticket vs. Password
AD_DOMAIN="yourcompany.com"

#
# Parameters for Centrify Repo
# get the following URL from the Centrify Support site
REPO_URL="https://***your_account_goes_here***@repo.centrify.com/rpm-redhat/"
# Also update the function install_centrifydc which also has a copy of this
...
supersede domain-name "gcp.centrify.demo" ; 
...
[centrify]
name=centrify
baseurl=https://***Centrify-Support-Account-goes-here***@repo.centrify.com/rpm-redhat/
enabled=1
repo_gpgcheck=1
gpgcheck=1
